  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "app-card": "0 4px 24px -4px rgba(26, 26, 26, 0.06), 0 1px 3px rgba(26, 26, 26, 0.04)",
        "app-float": "0 8px 32px -8px rgba(26, 26, 26, 0.1), 0 2px 8px rgba(26, 26, 26, 0.04)",
        "app-nav-active": "0 2px 12px rgba(26, 26, 26, 0.08), 0 1px 3px rgba(26, 26, 26, 0.04)",
      },
      backgroundImage: {
