  ...
  return (
    <AnimatedAppPage wide>
      ...
      <PageIntro
        ...
        body="Coverage maps, criteria heatmaps, failure boards, structured QA reports, and Canary adversarial probes."
      />
        ...
        <>
          ...
          <Panel>
            <PanelHeader
              ...
              body={`Test cases generated by ${AGENT_NAMES.NEEL} during pipeline runs.`}
            />
          ...
          {selectedPipelineId && pipelineReport ? (
            <Panel>
              <PanelHeader
                ...
                body={pipelineReport.testSummary}
              />
        ...
        <>
          <Panel>
            <PanelHeader
              ...
              body="Hypothesis-driven exploration against staging or production. Runs after pipeline QA and on a schedule."
              right={
                <button
                  type="button"
          ...
          {selectedRun ? (
            <Panel>
              <PanelHeader
                ...
                body={`${selectedRun.environment} · ${selectedRun.scope} · ${selectedRun.targetUrl}`}
              />
