    ...
    <div className="flex min-h-[calc(100vh-12rem)] flex-col">
      <header className="app-card border border-app-border px-5 py-4 sm:px-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <p className="type-kicker">⚙️ Engineering Agent</p>
...
function EngineeringEmptyState() {
  return (
    <Panel className="flex flex-col items-center px-8 py-16 text-center">
      <div className="flex size-16 items-center justify-center rounded-full bg-indigo/10 text-2xl">
        ⚙️
      </div>
      <h2 className="mt-6 text-xl font-semibold text-app-ink">
        The Engineering Agent hasn&apos;t built anything yet.
      </h2>
      <p className="mt-2 max-w-md text-sm text-app-ink-dim">
        Create a Jira ticket and let the full pipeline run. When the Engineering Agent
        completes, everything it built will appear here.
      </p>
      <Link
        to="/app/pipelines"
...
function LiveRunPanel({ steps }) {
  return (
    <div className="px-5 py-6 sm:px-6">
      <p className="type-kicker">Engineering Agent — Live</p>
