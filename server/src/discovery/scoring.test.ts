  ...
  it("runProductValidation returns gate and bands", () => {
    const result = runProductValidation({
      ...
      prd: {
        ...
        risks: [],
        successMetrics: [],
        complexitySummary: { score: 6, effortOptimistic: "6d", effortRealistic: "9d", effortPessimistic: "12d", keyComplexityDrivers: [] },
        prdConfidence: 0.99,
        confidenceNotes: "",
      },
      retrievedContext: [
      ...
      complexityAssessment: {
        ...
        effortEstimate: { optimistic: 5, realistic: 8, pessimistic: 12, unit: "days" },
        complexityDrivers: [],
        estimateRisks: [],
